...
uint256 hashGenesisBlock("0xee528a76552db1471e81dc64c46fb4f637671131fb90643f4c073692a9f65640");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // InstaMineNuggetsCLASSB: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "InstaMineNuggetsCLASSB Signed Message:\n";
...
{
    // InstaMineNuggetsCLASSB: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // InstaMineNuggetsCLASSB: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // InstaMineNuggetsCLASSB: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // InstaMineNuggetsCLASSB: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xee528a76552db1471e81dc64c46fb4f637671131fb90643f4c073692a9f65640");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1422565363;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085133844;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("InstaMineNuggetsCLASSBMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("InstaMineNuggetsCLASSBMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("InstaMineNuggetsCLASSBMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running InstaMineNuggetsCLASSB with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("InstaMineNuggetsCLASSBMiner terminated\n");
        throw;
    }
}
